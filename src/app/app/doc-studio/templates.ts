  ...
  },
  {
    ...
    instrumentBlocks: [
      ...
      },
      {
        type: 'instruction',
        label: 'Conclusão',
        text: 'Descreva os principais insights e análises após a observação, ressaltando pontos relevantes sobre o comportamento lúdico, emocional, cognitivo e social do paciente.',
      },
      { type: 'line-field', label: '', length: 'long' },
      { type: 'line-field', label: '', length: 'long' },
      { type: 'line-field', label: '', length: 'long' },
