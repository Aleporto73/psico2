...
export default function AppAssistenteAbaPage() {
  const supabase = createClient();
  const [hasAccess, setHasAccess] = useState<boolean | null>(null);
  const [loading, setLoading] = useState(true);

  const gptBuilderUrl = 'https://chatgpt.com/g/g-67942a69d214819187d2191865f0e269-informapsi-aba';
    ...
    return (
      <div className="bg-pp-block-coral rounded-block p-10 max-w-2xl mx-auto my-12 text-center flex flex-col items-center gap-6">
        ...
        <div className="space-y-3">
          <h2 className="font-serif italic text-2xl md:text-3xl text-pp-ink">Assistente ABA bloqueado</h2>
          <p className="text-pp-ink-soft text-base leading-relaxed">
            O Assistente ABA Incluso é um bônus exclusivo do plano vitalício. Adquira o acesso vitalício para liberar esta ferramenta e toda a biblioteca de planilhas profissionais.
          </p>
        </div>
        <Link
          href="/app/produtos"
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      ...
      <header className="space-y-2 pt-4">
        <h1 className="font-serif italic text-4xl md:text-5xl text-pp-ink leading-tight">Assistente ABA</h1>
        <p className="text-pp-ink-soft text-base md:text-lg">
          Apoio para avaliação funcional, planejamento de intervenção e ensino de habilidades.
        </p>
      </header>
      ...
      <div className="bg-pp-block-mint rounded-block p-8 md:p-10 space-y-6">
        ...
        <div className="space-y-3">
          ...
          <p className="text-pp-ink-soft text-base leading-relaxed">
            Como cliente PsicoPlanilhas Vitalício, você tem acesso ao nosso assistente GPT especialista em Análise do Comportamento Aplicada. Ele apoia avaliações funcionais, planejamento de estratégias e ensino de habilidades, com sugestões que consideram faixa etária e nível de desenvolvimento.
          </p>
          <p className="text-pp-ink-soft text-base leading-relaxed">
