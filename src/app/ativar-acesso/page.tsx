          ...
          <div className="space-y-5">
            <div className="p-6 text-center space-y-4 bg-[#34D399]/10 border border-[#34D399]/20 rounded-xl">
              <div className="w-14 h-14 mx-auto rounded-full bg-[#34D399]/20 flex items-center justify-center">
                <svg className="w-7 h-7 text-[#34D399]" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
            ...
            <Link
              href="/login"
              className="block w-full py-4 text-center text-base font-bold bg-[#0E2A38] text-[#F8FAFC] border border-[#1F4D5C] hover:border-[#7DD3FC] rounded-xl transition duration-200"
            >
              Voltar ao login
            </Link>
          </div>
