...
// Quatro produtos one_time (vitalício, flow, doc-studio, corrigefacil) gravam
// em purchases; assistente-ia-pro é o único subscription (grava em
// subscriptions).
...
export async function POST(request: Request) {
  ...
  try {
    ...
    // Vitalício, Flow, Doc Studio e CorrigeFácil são os quatro produtos
    // one_time suportados -> todos gravam em purchases via
    // upsertLifetimePurchase e NUNCA usam subscriptions. Falha em
